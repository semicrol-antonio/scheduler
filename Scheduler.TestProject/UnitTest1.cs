...
namespace Scheduler.TestProject
{
    public class UnitTest1
    {
        ...
        public void TypeDaily_NoHourly()
        {
            ...
            Assert.Equal(data[0].Description, "Ocurre cada 2 dia(s). La siguiente cita se producirá el 15/01/2021 a las 13:14 comenzando el 01/01/2021");

            sm.Language = SupportedLanguagesEnum.es_ES;
            sm.CurrentDate = new DateTime(2021, 1, 15, 13, 14, 0);
            data = sm.NextOcurrence();
            Assert.Equal(data[0].OcurrenceDate, new DateTime(2021, 1, 17, 13, 14, 0));
            Assert.Equal(data[0].Description, "Ocurre cada 2 dia(s). La siguiente cita se producirá el 17/01/2021 a las 13:14 comenzando el 01/01/2021");
        ...
        public void TypeDaily_HourlyFixed()
        {
            ...
            Assert.Equal(data[0].Description, "Ocurre cada 2 dia(s) a las 12:13. La siguiente cita se producirá el 13/01/2021 a las 12:13 comenzando el 01/01/2021");

            sm.Language = SupportedLanguagesEnum.es_ES;
            sm.CurrentDate = new DateTime(2021, 1, 13, 12, 13, 14);
            data = sm.NextOcurrence();
            Assert.Equal(data[0].OcurrenceDate, new DateTime(2021, 1, 15, 12, 13, 14));
            Assert.Equal(data[0].Description, "Ocurre cada 2 dia(s) a las 12:13. La siguiente cita se producirá el 15/01/2021 a las 12:13 comenzando el 01/01/2021");
            ...
            data = sm.NextOcurrence();
            Assert.Equal(data[0].OcurrenceDate, new DateTime(2021, 1, 13, 12, 13, 14));
            Assert.Equal(data[0].Description, "Occurs every 2 day(s) at 12:13. Schedule will be used on 1/13/2021 at 12:13 PM starting on 1/1/2021");

            sm.Language = SupportedLanguagesEnum.en_US;
            sm.CurrentDate = new DateTime(2021, 1, 13, 12, 13, 14);
            data = sm.NextOcurrence();
            Assert.Equal(data[0].OcurrenceDate, new DateTime(2021, 1, 15, 12, 13, 14));
            Assert.Equal(data[0].Description, "Occurs every 2 day(s) at 12:13. Schedule will be used on 1/15/2021 at 12:13 PM starting on 1/1/2021");
        }
        [Fact]
        public void TypeDaily_HourlyEvery()
        {
            ...
            Assert.Equal(data[0].Description, "Ocurre cada 2 dia(s). Cada 2 hora(s) entre 04:00 y 08:00. La siguiente cita se producirá el 13/01/2021 a las 4:00 comenzando el 01/01/2021");

            sm.CurrentDate = new DateTime(2021, 1, 13, 4, 0, 0);
            data = sm.NextOcurrence();
            Assert.Equal(data[0].OcurrenceDate, new DateTime(2021, 1, 13, 6, 0, 0));
            Assert.Equal(data[0].Description, "Ocurre cada 2 dia(s). Cada 2 hora(s) entre 04:00 y 08:00. La siguiente cita se producirá el 13/01/2021 a las 6:00 comenzando el 01/01/2021");

            sm.CurrentDate = new DateTime(2021, 1, 13, 6, 0, 0);
            data = sm.NextOcurrence();
            Assert.Equal(data[0].OcurrenceDate, new DateTime(2021, 1, 13, 8, 0, 0));
            Assert.Equal(data[0].Description, "Ocurre cada 2 dia(s). Cada 2 hora(s) entre 04:00 y 08:00. La siguiente cita se producirá el 13/01/2021 a las 8:00 comenzando el 01/01/2021");

            sm.CurrentDate = new DateTime(2021, 1, 13, 8, 0, 0);
            data = sm.NextOcurrence();
            Assert.Equal(data[0].OcurrenceDate, new DateTime(2021, 1, 15, 4, 0, 0));
            Assert.Equal(data[0].Description, "Ocurre cada 2 dia(s). Cada 2 hora(s) entre 04:00 y 08:00. La siguiente cita se producirá el 15/01/2021 a las 4:00 comenzando el 01/01/2021");
            ...
            data = sm.NextOcurrence();
            Assert.Equal(data[0].OcurrenceDate, new DateTime(2021, 1, 13, 4, 0, 0));
            Assert.Equal(data[0].Description, "Occurs every 2 day(s). Every 2 hour(s) between 04:00 and 08:00. Schedule will be used on 1/13/2021 at 4:00 AM starting on 1/1/2021");

            sm.CurrentDate = new DateTime(2021, 1, 13, 4, 0, 0);
            data = sm.NextOcurrence();
            Assert.Equal(data[0].OcurrenceDate, new DateTime(2021, 1, 13, 6, 0, 0));
            Assert.Equal(data[0].Description, "Occurs every 2 day(s). Every 2 hour(s) between 04:00 and 08:00. Schedule will be used on 1/13/2021 at 6:00 AM starting on 1/1/2021");

            sm.CurrentDate = new DateTime(2021, 1, 13, 6, 0, 0);
            data = sm.NextOcurrence();
            Assert.Equal(data[0].OcurrenceDate, new DateTime(2021, 1, 13, 8, 0, 0));
            Assert.Equal(data[0].Description, "Occurs every 2 day(s). Every 2 hour(s) between 04:00 and 08:00. Schedule will be used on 1/13/2021 at 8:00 AM starting on 1/1/2021");

            sm.CurrentDate = new DateTime(2021, 1, 13, 8, 0, 0);
            data = sm.NextOcurrence();
            Assert.Equal(data[0].OcurrenceDate, new DateTime(2021, 1, 15, 4, 0, 0));
            Assert.Equal(data[0].Description, "Occurs every 2 day(s). Every 2 hour(s) between 04:00 and 08:00. Schedule will be used on 1/15/2021 at 4:00 AM starting on 1/1/2021");
        ...
        public void TypeWeekly_HourlyFixed()
        {
            ...
            data = sm.NextOcurrence();
            Assert.Equal(data[0].OcurrenceDate, new DateTime(2021, 1, 14, 12, 13, 14));
            Assert.Equal(data[0].Description, "Occurs every 2 week(s) on monday, thursday, friday at 12:13. Schedule will be used on 1/14/2021 at 12:13 PM starting on 1/1/2021");

            sm.CurrentDate = new DateTime(2021, 1, 14, 12, 13, 14);
            data = sm.NextOcurrence();
            Assert.Equal(data[0].OcurrenceDate, new DateTime(2021, 1, 15, 12, 13, 14));
            Assert.Equal(data[0].Description, "Occurs every 2 week(s) on monday, thursday, friday at 12:13. Schedule will be used on 1/15/2021 at 12:13 PM starting on 1/1/2021");

            sm.CurrentDate = new DateTime(2021, 1, 15, 12, 13, 14);
            data = sm.NextOcurrence();
            Assert.Equal(data[0].OcurrenceDate, new DateTime(2021, 1, 25, 12, 13, 14));
            Assert.Equal(data[0].Description, "Occurs every 2 week(s) on monday, thursday, friday at 12:13. Schedule will be used on 1/25/2021 at 12:13 PM starting on 1/1/2021");

            sm.CurrentDate = new DateTime(2021, 1, 25, 12, 13, 14);
            data = sm.NextOcurrence();
            Assert.Equal(data[0].OcurrenceDate, new DateTime(2021, 1, 28, 12, 13, 14));
            Assert.Equal(data[0].Description, "Occurs every 2 week(s) on monday, thursday, friday at 12:13. Schedule will be used on 1/28/2021 at 12:13 PM starting on 1/1/2021");
        }
        [Fact]
        public void TypeWeekly_HourlyEvery()
        {
            ...
            Assert.Equal(data[0].Description, "Ocurre cada 2 semana(s) el lunes, jueves, viernes. Cada 2 hora(s) entre 04:00 y 08:00. La siguiente cita se producirá el 14/01/2021 a las 4:00 comenzando el 01/01/2021");

            sm.CurrentDate = new DateTime(2021, 1, 14, 4, 0, 0);
            data = sm.NextOcurrence();
            Assert.Equal(data[0].OcurrenceDate, new DateTime(2021, 1, 14, 6, 0, 0));
            Assert.Equal(data[0].Description, "Ocurre cada 2 semana(s) el lunes, jueves, viernes. Cada 2 hora(s) entre 04:00 y 08:00. La siguiente cita se producirá el 14/01/2021 a las 6:00 comenzando el 01/01/2021");

            sm.CurrentDate = new DateTime(2021, 1, 14, 6, 0, 0);
            data = sm.NextOcurrence();
            Assert.Equal(data[0].OcurrenceDate, new DateTime(2021, 1, 14, 8, 0, 0));
            Assert.Equal(data[0].Description, "Ocurre cada 2 semana(s) el lunes, jueves, viernes. Cada 2 hora(s) entre 04:00 y 08:00. La siguiente cita se producirá el 14/01/2021 a las 8:00 comenzando el 01/01/2021");

            sm.CurrentDate = new DateTime(2021, 1, 14, 8, 0, 0);
            data = sm.NextOcurrence();
            Assert.Equal(data[0].OcurrenceDate, new DateTime(2021, 1, 15, 4, 0, 0));
            Assert.Equal(data[0].Description, "Ocurre cada 2 semana(s) el lunes, jueves, viernes. Cada 2 hora(s) entre 04:00 y 08:00. La siguiente cita se producirá el 15/01/2021 a las 4:00 comenzando el 01/01/2021");

            sm.CurrentDate = new DateTime(2021, 1, 15, 4, 0, 0);
            data = sm.NextOcurrence();
            Assert.Equal(data[0].OcurrenceDate, new DateTime(2021, 1, 15, 6, 0, 0));
            Assert.Equal(data[0].Description, "Ocurre cada 2 semana(s) el lunes, jueves, viernes. Cada 2 hora(s) entre 04:00 y 08:00. La siguiente cita se producirá el 15/01/2021 a las 6:00 comenzando el 01/01/2021");

            sm.CurrentDate = new DateTime(2021, 1, 15, 6, 0, 0);
            data = sm.NextOcurrence();
            Assert.Equal(data[0].OcurrenceDate, new DateTime(2021, 1, 15, 8, 0, 0));
            Assert.Equal(data[0].Description, "Ocurre cada 2 semana(s) el lunes, jueves, viernes. Cada 2 hora(s) entre 04:00 y 08:00. La siguiente cita se producirá el 15/01/2021 a las 8:00 comenzando el 01/01/2021");

            sm.CurrentDate = new DateTime(2021, 1, 15, 8, 0, 0);
            data = sm.NextOcurrence();
            Assert.Equal(data[0].OcurrenceDate, new DateTime(2021, 1, 25, 4, 0, 0));
            Assert.Equal(data[0].Description, "Ocurre cada 2 semana(s) el lunes, jueves, viernes. Cada 2 hora(s) entre 04:00 y 08:00. La siguiente cita se producirá el 25/01/2021 a las 4:00 comenzando el 01/01/2021");

            sm.CurrentDate = new DateTime(2021, 1, 25, 4, 0, 0);
            data = sm.NextOcurrence();
            Assert.Equal(data[0].OcurrenceDate, new DateTime(2021, 1, 25, 6, 0, 0));
            Assert.Equal(data[0].Description, "Ocurre cada 2 semana(s) el lunes, jueves, viernes. Cada 2 hora(s) entre 04:00 y 08:00. La siguiente cita se producirá el 25/01/2021 a las 6:00 comenzando el 01/01/2021");

            sm.CurrentDate = new DateTime(2021, 1, 25, 6, 0, 0);
            data = sm.NextOcurrence();
            Assert.Equal(data[0].OcurrenceDate, new DateTime(2021, 1, 25, 8, 0, 0));
            Assert.Equal(data[0].Description, "Ocurre cada 2 semana(s) el lunes, jueves, viernes. Cada 2 hora(s) entre 04:00 y 08:00. La siguiente cita se producirá el 25/01/2021 a las 8:00 comenzando el 01/01/2021");

            sm.CurrentDate = new DateTime(2021, 1, 25, 8, 0, 0);
            data = sm.NextOcurrence();
            Assert.Equal(data[0].OcurrenceDate, new DateTime(2021, 1, 28, 4, 0, 0));
            Assert.Equal(data[0].Description, "Ocurre cada 2 semana(s) el lunes, jueves, viernes. Cada 2 hora(s) entre 04:00 y 08:00. La siguiente cita se producirá el 28/01/2021 a las 4:00 comenzando el 01/01/2021");

            sm.CurrentDate = new DateTime(2021, 1, 28, 4, 0, 0);
            data = sm.NextOcurrence();
            Assert.Equal(data[0].OcurrenceDate, new DateTime(2021, 1, 28, 6, 0, 0));
            Assert.Equal(data[0].Description, "Ocurre cada 2 semana(s) el lunes, jueves, viernes. Cada 2 hora(s) entre 04:00 y 08:00. La siguiente cita se producirá el 28/01/2021 a las 6:00 comenzando el 01/01/2021");

            sm.CurrentDate = new DateTime(2021, 1, 28, 6, 0, 0);
            data = sm.NextOcurrence();
            Assert.Equal(data[0].OcurrenceDate, new DateTime(2021, 1, 28, 8, 0, 0));
            Assert.Equal(data[0].Description, "Ocurre cada 2 semana(s) el lunes, jueves, viernes. Cada 2 hora(s) entre 04:00 y 08:00. La siguiente cita se producirá el 28/01/2021 a las 8:00 comenzando el 01/01/2021");
            ...
            data = sm.NextOcurrence();
            Assert.Equal(data[0].OcurrenceDate, new DateTime(2021, 1, 14, 4, 0, 0));
            Assert.Equal(data[0].Description, "Occurs every 2 week(s) on monday, thursday, friday. Every 2 hour(s) between 04:00 and 08:00. Schedule will be used on 1/14/2021 at 4:00 AM starting on 1/1/2021");

            sm.CurrentDate = new DateTime(2021, 1, 14, 4, 0, 0);
            data = sm.NextOcurrence();
            Assert.Equal(data[0].OcurrenceDate, new DateTime(2021, 1, 14, 6, 0, 0));
            Assert.Equal(data[0].Description, "Occurs every 2 week(s) on monday, thursday, friday. Every 2 hour(s) between 04:00 and 08:00. Schedule will be used on 1/14/2021 at 6:00 AM starting on 1/1/2021");

            sm.CurrentDate = new DateTime(2021, 1, 14, 6, 0, 0);
            data = sm.NextOcurrence();
            Assert.Equal(data[0].OcurrenceDate, new DateTime(2021, 1, 14, 8, 0, 0));
            Assert.Equal(data[0].Description, "Occurs every 2 week(s) on monday, thursday, friday. Every 2 hour(s) between 04:00 and 08:00. Schedule will be used on 1/14/2021 at 8:00 AM starting on 1/1/2021");

            sm.CurrentDate = new DateTime(2021, 1, 14, 8, 0, 0);
            data = sm.NextOcurrence();
            Assert.Equal(data[0].OcurrenceDate, new DateTime(2021, 1, 15, 4, 0, 0));
            Assert.Equal(data[0].Description, "Occurs every 2 week(s) on monday, thursday, friday. Every 2 hour(s) between 04:00 and 08:00. Schedule will be used on 1/15/2021 at 4:00 AM starting on 1/1/2021");

            sm.CurrentDate = new DateTime(2021, 1, 15, 4, 0, 0);
            data = sm.NextOcurrence();
            Assert.Equal(data[0].OcurrenceDate, new DateTime(2021, 1, 15, 6, 0, 0));
            Assert.Equal(data[0].Description, "Occurs every 2 week(s) on monday, thursday, friday. Every 2 hour(s) between 04:00 and 08:00. Schedule will be used on 1/15/2021 at 6:00 AM starting on 1/1/2021");

            sm.CurrentDate = new DateTime(2021, 1, 15, 6, 0, 0);
            data = sm.NextOcurrence();
            Assert.Equal(data[0].OcurrenceDate, new DateTime(2021, 1, 15, 8, 0, 0));
            Assert.Equal(data[0].Description, "Occurs every 2 week(s) on monday, thursday, friday. Every 2 hour(s) between 04:00 and 08:00. Schedule will be used on 1/15/2021 at 8:00 AM starting on 1/1/2021");

            sm.CurrentDate = new DateTime(2021, 1, 15, 8, 0, 0);
            data = sm.NextOcurrence();
            Assert.Equal(data[0].OcurrenceDate, new DateTime(2021, 1, 25, 4, 0, 0));
            Assert.Equal(data[0].Description, "Occurs every 2 week(s) on monday, thursday, friday. Every 2 hour(s) between 04:00 and 08:00. Schedule will be used on 1/25/2021 at 4:00 AM starting on 1/1/2021");

            sm.CurrentDate = new DateTime(2021, 1, 25, 4, 0, 0);
            data = sm.NextOcurrence();
            Assert.Equal(data[0].OcurrenceDate, new DateTime(2021, 1, 25, 6, 0, 0));
            Assert.Equal(data[0].Description, "Occurs every 2 week(s) on monday, thursday, friday. Every 2 hour(s) between 04:00 and 08:00. Schedule will be used on 1/25/2021 at 6:00 AM starting on 1/1/2021");

            sm.CurrentDate = new DateTime(2021, 1, 25, 6, 0, 0);
            data = sm.NextOcurrence();
            Assert.Equal(data[0].OcurrenceDate, new DateTime(2021, 1, 25, 8, 0, 0));
            Assert.Equal(data[0].Description, "Occurs every 2 week(s) on monday, thursday, friday. Every 2 hour(s) between 04:00 and 08:00. Schedule will be used on 1/25/2021 at 8:00 AM starting on 1/1/2021");

            sm.CurrentDate = new DateTime(2021, 1, 25, 8, 0, 0);
            data = sm.NextOcurrence();
            Assert.Equal(data[0].OcurrenceDate, new DateTime(2021, 1, 28, 4, 0, 0));
            Assert.Equal(data[0].Description, "Occurs every 2 week(s) on monday, thursday, friday. Every 2 hour(s) between 04:00 and 08:00. Schedule will be used on 1/28/2021 at 4:00 AM starting on 1/1/2021");

            sm.CurrentDate = new DateTime(2021, 1, 28, 4, 0, 0);
            data = sm.NextOcurrence();
            Assert.Equal(data[0].OcurrenceDate, new DateTime(2021, 1, 28, 6, 0, 0));
            Assert.Equal(data[0].Description, "Occurs every 2 week(s) on monday, thursday, friday. Every 2 hour(s) between 04:00 and 08:00. Schedule will be used on 1/28/2021 at 6:00 AM starting on 1/1/2021");

            sm.CurrentDate = new DateTime(2021, 1, 28, 6, 0, 0);
            data = sm.NextOcurrence();
            Assert.Equal(data[0].OcurrenceDate, new DateTime(2021, 1, 28, 8, 0, 0));
            Assert.Equal(data[0].Description, "Occurs every 2 week(s) on monday, thursday, friday. Every 2 hour(s) between 04:00 and 08:00. Schedule will be used on 1/28/2021 at 8:00 AM starting on 1/1/2021");
        ...
        public void TypeMonthly_NoHourly_FixedDay()
        {
            ...
            Assert.Equal(data[0].Description, "Ocurre el dia 31 de cada 2 mes(es). La siguiente cita se producirá el 31/01/2020 a las 0:00 comenzando el 01/01/2020");

            sm.CurrentDate = new DateTime(2020, 1, 31, 0, 0, 0);
            data = sm.NextOcurrence();
            Assert.Equal(data[0].OcurrenceDate, new DateTime(2020, 3,31, 0, 0, 0));
            Assert.Equal(data[0].Description, "Ocurre el dia 31 de cada 2 mes(es). La siguiente cita se producirá el 31/03/2020 a las 0:00 comenzando el 01/01/2020");

            sm.CurrentDate = new DateTime(2020, 3, 31, 0, 0, 0);
            data = sm.NextOcurrence();
            Assert.Equal(data[0].OcurrenceDate, new DateTime(2020, 5, 31, 0, 0, 0));
            Assert.Equal(data[0].Description, "Ocurre el dia 31 de cada 2 mes(es). La siguiente cita se producirá el 31/05/2020 a las 0:00 comenzando el 01/01/2020");

            sm.CurrentDate = new DateTime(2020, 10, 17, 0, 0, 0);
            data = sm.NextOcurrence();
            Assert.Equal(data[0].OcurrenceDate, new DateTime(2020, 10, 31, 0, 0, 0));
            Assert.Equal(data[0].Description, "Ocurre el dia 31 de cada 2 mes(es). La siguiente cita se producirá el 31/10/2020 a las 0:00 comenzando el 01/01/2020");

            sm.CurrentDate = new DateTime(2020, 10, 31, 0, 0, 0);
            data = sm.NextOcurrence();
            Assert.Equal(data[0].OcurrenceDate, new DateTime(2020, 12, 31, 0, 0, 0));
            Assert.Equal(data[0].Description, "Ocurre el dia 31 de cada 2 mes(es). La siguiente cita se producirá el 31/12/2020 a las 0:00 comenzando el 01/01/2020");

            sm.CurrentDate = new DateTime(2020, 12, 31, 0, 0, 0);
            data = sm.NextOcurrence();
            Assert.Equal(data[0].OcurrenceDate, new DateTime(2021, 2, 28, 0, 0, 0));
            Assert.Equal(data[0].Description, "Ocurre el dia 31 de cada 2 mes(es). La siguiente cita se producirá el 28/02/2021 a las 0:00 comenzando el 01/01/2020");
        ...
        public void TypeMonthly_NoHourly_DayPosition()
        {
            ...
            data = sm.NextOcurrence();
            Assert.Equal(data[0].OcurrenceDate, new DateTime(2021, 12, 4, 0, 0, 0));
            Assert.Equal(data[0].Description, "Ocurre el primer dia del fin de semana de cada 2 mes(es). La siguiente cita se producirá el 04/12/2021 a las 0:00 comenzando el 01/01/2021");

            sm.CurrentDate = new DateTime(2021, 12, 4, 0, 0, 0);
            data = sm.NextOcurrence();
            Assert.Equal(data[0].OcurrenceDate, new DateTime(2022, 2, 5, 0, 0, 0));
            Assert.Equal(data[0].Description, "Ocurre el primer dia del fin de semana de cada 2 mes(es). La siguiente cita se producirá el 05/02/2022 a las 0:00 comenzando el 01/01/2021");
            ...
            Assert.Equal(data[0].Description, "Ocurre el segundo dia del fin de semana de cada 2 mes(es). La siguiente cita se producirá el 05/12/2021 a las 0:00 comenzando el 01/01/2021");

            sm.CurrentDate = new DateTime(2021, 12, 5, 0, 0, 0);
            data = sm.NextOcurrence();
            Assert.Equal(data[0].OcurrenceDate, new DateTime(2022, 2, 6, 0, 0, 0));
            Assert.Equal(data[0].Description, "Ocurre el segundo dia del fin de semana de cada 2 mes(es). La siguiente cita se producirá el 06/02/2022 a las 0:00 comenzando el 01/01/2021");
            ...
            data = sm.NextOcurrence();
            Assert.Equal(data[0].OcurrenceDate, new DateTime(2021, 12, 11, 0, 0, 0));
            Assert.Equal(data[0].Description, "Ocurre el tercer dia del fin de semana de cada 2 mes(es). La siguiente cita se producirá el 11/12/2021 a las 0:00 comenzando el 01/01/2021");

            sm.CurrentDate = new DateTime(2021, 12, 11, 0, 0, 0);
            data = sm.NextOcurrence();
            Assert.Equal(data[0].OcurrenceDate, new DateTime(2022, 2, 12, 0, 0, 0));
            Assert.Equal(data[0].Description, "Ocurre el tercer dia del fin de semana de cada 2 mes(es). La siguiente cita se producirá el 12/02/2022 a las 0:00 comenzando el 01/01/2021");
            ...
            Assert.Equal(data[0].Description, "Ocurre el cuarto dia del fin de semana de cada 2 mes(es). La siguiente cita se producirá el 12/12/2021 a las 0:00 comenzando el 01/01/2021");

            sm.CurrentDate = new DateTime(2021, 12, 12, 0, 0, 0);
            data = sm.NextOcurrence();
            Assert.Equal(data[0].OcurrenceDate, new DateTime(2022, 2, 13, 0, 0, 0));
            Assert.Equal(data[0].Description, "Ocurre el cuarto dia del fin de semana de cada 2 mes(es). La siguiente cita se producirá el 13/02/2022 a las 0:00 comenzando el 01/01/2021");
            ...
            Assert.Equal(data[0].Description, "Ocurre el ultimo dia del fin de semana de cada 2 mes(es). La siguiente cita se producirá el 31/10/2021 a las 0:00 comenzando el 01/01/2021");

            sm.CurrentDate = new DateTime(2021, 10, 31, 0, 0, 0);
            data = sm.NextOcurrence();
            Assert.Equal(data[0].OcurrenceDate, new DateTime(2021, 12, 26, 0, 0, 0));
            Assert.Equal(data[0].Description, "Ocurre el ultimo dia del fin de semana de cada 2 mes(es). La siguiente cita se producirá el 26/12/2021 a las 0:00 comenzando el 01/01/2021");
            ...
            Assert.Equal(data[0].Description, "Ocurre el primer dia de cada 2 mes(es). La siguiente cita se producirá el 01/12/2021 a las 0:00 comenzando el 01/01/2021");

            sm.CurrentDate = new DateTime(2021, 12, 1, 0, 0, 0);
            data = sm.NextOcurrence();
            Assert.Equal(data[0].OcurrenceDate, new DateTime(2022, 2, 1, 0, 0, 0));
            Assert.Equal(data[0].Description, "Ocurre el primer dia de cada 2 mes(es). La siguiente cita se producirá el 01/02/2022 a las 0:00 comenzando el 01/01/2021");
            ...
            data = sm.NextOcurrence();
            Assert.Equal(data[0].OcurrenceDate, new DateTime(2021, 10, 31, 0, 0, 0));
            Assert.Equal(data[0].Description, "Ocurre el ultimo dia de cada 2 mes(es). La siguiente cita se producirá el 31/10/2021 a las 0:00 comenzando el 01/01/2021");

            sm.CurrentDate = new DateTime(2021, 10, 31, 0, 0, 0);
            data = sm.NextOcurrence();
            Assert.Equal(data[0].OcurrenceDate, new DateTime(2021, 12, 31, 0, 0, 0));
            Assert.Equal(data[0].Description, "Ocurre el ultimo dia de cada 2 mes(es). La siguiente cita se producirá el 31/12/2021 a las 0:00 comenzando el 01/01/2021");
            ...
            data = sm.NextOcurrence();
            Assert.Equal(data[0].OcurrenceDate, new DateTime(2021, 12, 1, 0, 0, 0));
            Assert.Equal(data[0].Description, "Ocurre el primer dia laboral de cada 2 mes(es). La siguiente cita se producirá el 01/12/2021 a las 0:00 comenzando el 01/01/2021");

            sm.CurrentDate = new DateTime(2021, 12, 1, 0, 0, 0);
            data = sm.NextOcurrence();
            Assert.Equal(data[0].OcurrenceDate, new DateTime(2022, 2, 1, 0, 0, 0));
            Assert.Equal(data[0].Description, "Ocurre el primer dia laboral de cada 2 mes(es). La siguiente cita se producirá el 01/02/2022 a las 0:00 comenzando el 01/01/2021");
            ...
            Assert.Equal(data[0].Description, "Ocurre el ultimo dia laboral de cada 2 mes(es). La siguiente cita se producirá el 29/10/2021 a las 0:00 comenzando el 01/01/2021");

            sm.CurrentDate = new DateTime(2021, 10, 29, 0, 0, 0);
            data = sm.NextOcurrence();
            Assert.Equal(data[0].OcurrenceDate, new DateTime(2021, 12, 31, 0, 0, 0));
            Assert.Equal(data[0].Description, "Ocurre el ultimo dia laboral de cada 2 mes(es). La siguiente cita se producirá el 31/12/2021 a las 0:00 comenzando el 01/01/2021");
        ...
        public void TypeMonthly_Hourly_FixedDay()
        {
            ...
            Assert.Equal(data[0].Description, "Ocurre el dia 31 de cada 2 mes(es). Cada 2 hora(s) entre 04:00 y 08:00. La siguiente cita se producirá el 31/01/2020 a las 4:00 comenzando el 01/01/2020");

            sm.CurrentDate = new DateTime(2020, 1,31, 4, 0, 0);
            data = sm.NextOcurrence();
            Assert.Equal(data[0].OcurrenceDate, new DateTime(2020, 1, 31, 6, 0, 0));
            Assert.Equal(data[0].Description, "Ocurre el dia 31 de cada 2 mes(es). Cada 2 hora(s) entre 04:00 y 08:00. La siguiente cita se producirá el 31/01/2020 a las 6:00 comenzando el 01/01/2020");

            sm.CurrentDate = new DateTime(2020, 1, 31, 6, 0, 0);
            data = sm.NextOcurrence();
            Assert.Equal(data[0].OcurrenceDate, new DateTime(2020, 1, 31, 8, 0, 0));
            Assert.Equal(data[0].Description, "Ocurre el dia 31 de cada 2 mes(es). Cada 2 hora(s) entre 04:00 y 08:00. La siguiente cita se producirá el 31/01/2020 a las 8:00 comenzando el 01/01/2020");

            sm.CurrentDate = new DateTime(2020, 1, 31, 8, 0, 0);
            data = sm.NextOcurrence();
            Assert.Equal(data[0].OcurrenceDate, new DateTime(2020, 3, 31, 4, 0, 0));
            Assert.Equal(data[0].Description, "Ocurre el dia 31 de cada 2 mes(es). Cada 2 hora(s) entre 04:00 y 08:00. La siguiente cita se producirá el 31/03/2020 a las 4:00 comenzando el 01/01/2020");

            sm.CurrentDate = new DateTime(2020, 3, 31, 4, 0, 0);
            data = sm.NextOcurrence();
            Assert.Equal(data[0].OcurrenceDate, new DateTime(2020, 3, 31, 6, 0, 0));
            Assert.Equal(data[0].Description, "Ocurre el dia 31 de cada 2 mes(es). Cada 2 hora(s) entre 04:00 y 08:00. La siguiente cita se producirá el 31/03/2020 a las 6:00 comenzando el 01/01/2020");

            sm.CurrentDate = new DateTime(2020, 3, 31, 6, 0, 0);
            data = sm.NextOcurrence();
            Assert.Equal(data[0].OcurrenceDate, new DateTime(2020, 3, 31, 8, 0, 0));
            Assert.Equal(data[0].Description, "Ocurre el dia 31 de cada 2 mes(es). Cada 2 hora(s) entre 04:00 y 08:00. La siguiente cita se producirá el 31/03/2020 a las 8:00 comenzando el 01/01/2020");

            sm.CurrentDate = new DateTime(2020, 3, 31, 8, 0, 0);
            data = sm.NextOcurrence();
            Assert.Equal(data[0].OcurrenceDate, new DateTime(2020, 5, 31, 4, 0, 0));
            Assert.Equal(data[0].Description, "Ocurre el dia 31 de cada 2 mes(es). Cada 2 hora(s) entre 04:00 y 08:00. La siguiente cita se producirá el 31/05/2020 a las 4:00 comenzando el 01/01/2020");

            sm.CurrentDate = new DateTime(2020, 5, 31, 4, 0, 0);
            data = sm.NextOcurrence();
            Assert.Equal(data[0].OcurrenceDate, new DateTime(2020, 5, 31, 6, 0, 0));
            Assert.Equal(data[0].Description, "Ocurre el dia 31 de cada 2 mes(es). Cada 2 hora(s) entre 04:00 y 08:00. La siguiente cita se producirá el 31/05/2020 a las 6:00 comenzando el 01/01/2020");

            sm.CurrentDate = new DateTime(2020, 5, 31, 6, 0, 0);
            data = sm.NextOcurrence();
            Assert.Equal(data[0].OcurrenceDate, new DateTime(2020, 5, 31, 8, 0, 0));
            Assert.Equal(data[0].Description, "Ocurre el dia 31 de cada 2 mes(es). Cada 2 hora(s) entre 04:00 y 08:00. La siguiente cita se producirá el 31/05/2020 a las 8:00 comenzando el 01/01/2020");

            sm.CurrentDate = new DateTime(2020, 5, 31, 8, 0, 0);
            data = sm.NextOcurrence();
            Assert.Equal(data[0].OcurrenceDate, new DateTime(2020, 7, 31, 4, 0, 0));
            Assert.Equal(data[0].Description, "Ocurre el dia 31 de cada 2 mes(es). Cada 2 hora(s) entre 04:00 y 08:00. La siguiente cita se producirá el 31/07/2020 a las 4:00 comenzando el 01/01/2020");
            ...
            data = sm.NextOcurrence();
            Assert.Equal(data[0].OcurrenceDate, new DateTime(2020, 1, 31, 4, 0, 0));
            Assert.Equal(data[0].Description, "Occurs on day 31 of every 2 month(s). Every 2 hour(s) between 04:00 and 08:00. Schedule will be used on 1/31/2020 at 4:00 AM starting on 1/1/2020");

            sm.CurrentDate = new DateTime(2020, 1, 31, 4, 0, 0);
            data = sm.NextOcurrence();
            Assert.Equal(data[0].OcurrenceDate, new DateTime(2020, 1, 31, 6, 0, 0));
            Assert.Equal(data[0].Description, "Occurs on day 31 of every 2 month(s). Every 2 hour(s) between 04:00 and 08:00. Schedule will be used on 1/31/2020 at 6:00 AM starting on 1/1/2020");

            sm.CurrentDate = new DateTime(2020, 1, 31, 6, 0, 0);
            data = sm.NextOcurrence();
            Assert.Equal(data[0].OcurrenceDate, new DateTime(2020, 1, 31, 8, 0, 0));
            Assert.Equal(data[0].Description, "Occurs on day 31 of every 2 month(s). Every 2 hour(s) between 04:00 and 08:00. Schedule will be used on 1/31/2020 at 8:00 AM starting on 1/1/2020");

            sm.CurrentDate = new DateTime(2020, 1, 31, 8, 0, 0);
            data = sm.NextOcurrence();
            Assert.Equal(data[0].OcurrenceDate, new DateTime(2020, 3, 31, 4, 0, 0));
            Assert.Equal(data[0].Description, "Occurs on day 31 of every 2 month(s). Every 2 hour(s) between 04:00 and 08:00. Schedule will be used on 3/31/2020 at 4:00 AM starting on 1/1/2020");

            sm.CurrentDate = new DateTime(2020, 3, 31, 4, 0, 0);
            data = sm.NextOcurrence();
            Assert.Equal(data[0].OcurrenceDate, new DateTime(2020, 3, 31, 6, 0, 0));
            Assert.Equal(data[0].Description, "Occurs on day 31 of every 2 month(s). Every 2 hour(s) between 04:00 and 08:00. Schedule will be used on 3/31/2020 at 6:00 AM starting on 1/1/2020");

            sm.CurrentDate = new DateTime(2020, 3, 31, 6, 0, 0);
            data = sm.NextOcurrence();
            Assert.Equal(data[0].OcurrenceDate, new DateTime(2020, 3, 31, 8, 0, 0));
            Assert.Equal(data[0].Description, "Occurs on day 31 of every 2 month(s). Every 2 hour(s) between 04:00 and 08:00. Schedule will be used on 3/31/2020 at 8:00 AM starting on 1/1/2020");

            sm.CurrentDate = new DateTime(2020, 3, 31, 8, 0, 0);
            data = sm.NextOcurrence();
            Assert.Equal(data[0].OcurrenceDate, new DateTime(2020, 5, 31, 4, 0, 0));
            Assert.Equal(data[0].Description, "Occurs on day 31 of every 2 month(s). Every 2 hour(s) between 04:00 and 08:00. Schedule will be used on 5/31/2020 at 4:00 AM starting on 1/1/2020");

            sm.CurrentDate = new DateTime(2020, 5, 31, 4, 0, 0);
            data = sm.NextOcurrence();
            Assert.Equal(data[0].OcurrenceDate, new DateTime(2020, 5, 31, 6, 0, 0));
            Assert.Equal(data[0].Description, "Occurs on day 31 of every 2 month(s). Every 2 hour(s) between 04:00 and 08:00. Schedule will be used on 5/31/2020 at 6:00 AM starting on 1/1/2020");

            sm.CurrentDate = new DateTime(2020, 5, 31, 6, 0, 0);
            data = sm.NextOcurrence();
            Assert.Equal(data[0].OcurrenceDate, new DateTime(2020, 5, 31, 8, 0, 0));
            Assert.Equal(data[0].Description, "Occurs on day 31 of every 2 month(s). Every 2 hour(s) between 04:00 and 08:00. Schedule will be used on 5/31/2020 at 8:00 AM starting on 1/1/2020");

            sm.CurrentDate = new DateTime(2020, 5, 31, 8, 0, 0);
            data = sm.NextOcurrence();
            Assert.Equal(data[0].OcurrenceDate, new DateTime(2020, 7, 31, 4, 0, 0));
            Assert.Equal(data[0].Description, "Occurs on day 31 of every 2 month(s). Every 2 hour(s) between 04:00 and 08:00. Schedule will be used on 7/31/2020 at 4:00 AM starting on 1/1/2020");
        ...
        public void TypeMonthly_Hourly_DayPosition()
        {
            ...
            Assert.Equal(data[0].Description, "Ocurre el primer lunes de cada 2 mes(es). Cada 2 hora(s) entre 04:00 y 08:00. La siguiente cita se producirá el 06/12/2021 a las 4:00 comenzando el 01/01/2021");

            sm.CurrentDate = new DateTime(2021, 12, 6, 4, 0, 0);
            data = sm.NextOcurrence();
            Assert.Equal(data[0].OcurrenceDate, new DateTime(2021, 12, 6, 6, 0, 0));
            Assert.Equal(data[0].Description, "Ocurre el primer lunes de cada 2 mes(es). Cada 2 hora(s) entre 04:00 y 08:00. La siguiente cita se producirá el 06/12/2021 a las 6:00 comenzando el 01/01/2021");

            sm.CurrentDate = new DateTime(2021, 12, 6, 6, 0, 0);
            data = sm.NextOcurrence();
            Assert.Equal(data[0].OcurrenceDate, new DateTime(2021, 12, 6, 8, 0, 0));
            Assert.Equal(data[0].Description, "Ocurre el primer lunes de cada 2 mes(es). Cada 2 hora(s) entre 04:00 y 08:00. La siguiente cita se producirá el 06/12/2021 a las 8:00 comenzando el 01/01/2021");

            sm.CurrentDate = new DateTime(2021, 12, 6, 8, 0, 0);
            data = sm.NextOcurrence();
            Assert.Equal(data[0].OcurrenceDate, new DateTime(2022, 2, 7, 4, 0, 0));
            Assert.Equal(data[0].Description, "Ocurre el primer lunes de cada 2 mes(es). Cada 2 hora(s) entre 04:00 y 08:00. La siguiente cita se producirá el 07/02/2022 a las 4:00 comenzando el 01/01/2021");
            ...
            Assert.Equal(data[0].Description, "Ocurre el segundo lunes de cada 2 mes(es). Cada 2 hora(s) entre 04:00 y 08:00. La siguiente cita se producirá el 13/12/2021 a las 4:00 comenzando el 01/01/2021");

            sm.CurrentDate = new DateTime(2021, 12, 13, 4, 0, 0);
            data = sm.NextOcurrence();
            Assert.Equal(data[0].OcurrenceDate, new DateTime(2021, 12, 13, 6, 0, 0));
            Assert.Equal(data[0].Description, "Ocurre el segundo lunes de cada 2 mes(es). Cada 2 hora(s) entre 04:00 y 08:00. La siguiente cita se producirá el 13/12/2021 a las 6:00 comenzando el 01/01/2021");

            sm.CurrentDate = new DateTime(2021, 12, 13, 6, 0, 0);
            data = sm.NextOcurrence();
            Assert.Equal(data[0].OcurrenceDate, new DateTime(2021, 12, 13, 8, 0, 0));
            Assert.Equal(data[0].Description, "Ocurre el segundo lunes de cada 2 mes(es). Cada 2 hora(s) entre 04:00 y 08:00. La siguiente cita se producirá el 13/12/2021 a las 8:00 comenzando el 01/01/2021");

            sm.CurrentDate = new DateTime(2021, 12, 13, 8, 0, 0);
            data = sm.NextOcurrence();
            Assert.Equal(data[0].OcurrenceDate, new DateTime(2022, 2, 14, 4, 0, 0));
            Assert.Equal(data[0].Description, "Ocurre el segundo lunes de cada 2 mes(es). Cada 2 hora(s) entre 04:00 y 08:00. La siguiente cita se producirá el 14/02/2022 a las 4:00 comenzando el 01/01/2021");
            ...
            Assert.Equal(data[0].Description, "Ocurre el tercer lunes de cada 2 mes(es). Cada 2 hora(s) entre 04:00 y 08:00. La siguiente cita se producirá el 18/10/2021 a las 4:00 comenzando el 01/01/2021");

            sm.CurrentDate = new DateTime(2021, 10, 18, 4, 0, 0);
            data = sm.NextOcurrence();
            Assert.Equal(data[0].OcurrenceDate, new DateTime(2021, 10, 18, 6, 0, 0));
            Assert.Equal(data[0].Description, "Ocurre el tercer lunes de cada 2 mes(es). Cada 2 hora(s) entre 04:00 y 08:00. La siguiente cita se producirá el 18/10/2021 a las 6:00 comenzando el 01/01/2021");

            sm.CurrentDate = new DateTime(2021, 10, 18, 6, 0, 0);
            data = sm.NextOcurrence();
            Assert.Equal(data[0].OcurrenceDate, new DateTime(2021, 10, 18, 8, 0, 0));
            Assert.Equal(data[0].Description, "Ocurre el tercer lunes de cada 2 mes(es). Cada 2 hora(s) entre 04:00 y 08:00. La siguiente cita se producirá el 18/10/2021 a las 8:00 comenzando el 01/01/2021");

            sm.CurrentDate = new DateTime(2021, 10, 18, 8, 0, 0);
            data = sm.NextOcurrence();
            Assert.Equal(data[0].OcurrenceDate, new DateTime(2021, 12, 20, 4, 0, 0));
            Assert.Equal(data[0].Description, "Ocurre el tercer lunes de cada 2 mes(es). Cada 2 hora(s) entre 04:00 y 08:00. La siguiente cita se producirá el 20/12/2021 a las 4:00 comenzando el 01/01/2021");
            ...
            Assert.Equal(data[0].Description, "Ocurre el cuarto lunes de cada 2 mes(es). Cada 2 hora(s) entre 04:00 y 08:00. La siguiente cita se producirá el 25/10/2021 a las 4:00 comenzando el 01/01/2021");

            sm.CurrentDate = new DateTime(2021, 10, 25, 4, 0, 0);
            data = sm.NextOcurrence();
            Assert.Equal(data[0].OcurrenceDate, new DateTime(2021, 10, 25, 6, 0, 0));
            Assert.Equal(data[0].Description, "Ocurre el cuarto lunes de cada 2 mes(es). Cada 2 hora(s) entre 04:00 y 08:00. La siguiente cita se producirá el 25/10/2021 a las 6:00 comenzando el 01/01/2021");

            sm.CurrentDate = new DateTime(2021, 10, 25, 6, 0, 0);
            data = sm.NextOcurrence();
            Assert.Equal(data[0].OcurrenceDate, new DateTime(2021, 10, 25, 8, 0, 0));
            Assert.Equal(data[0].Description, "Ocurre el cuarto lunes de cada 2 mes(es). Cada 2 hora(s) entre 04:00 y 08:00. La siguiente cita se producirá el 25/10/2021 a las 8:00 comenzando el 01/01/2021");

            sm.CurrentDate = new DateTime(2021, 10, 25, 8, 0, 0);
            data = sm.NextOcurrence();
            Assert.Equal(data[0].OcurrenceDate, new DateTime(2021, 12, 27, 4, 0, 0));
            Assert.Equal(data[0].Description, "Ocurre el cuarto lunes de cada 2 mes(es). Cada 2 hora(s) entre 04:00 y 08:00. La siguiente cita se producirá el 27/12/2021 a las 4:00 comenzando el 01/01/2021");
            ...
            data = sm.NextOcurrence();
            Assert.Equal(data[0].OcurrenceDate, new DateTime(2021, 10, 25, 4, 0, 0));
            Assert.Equal(data[0].Description, "Ocurre el ultimo lunes de cada 2 mes(es). Cada 2 hora(s) entre 04:00 y 08:00. La siguiente cita se producirá el 25/10/2021 a las 4:00 comenzando el 01/01/2021");

            sm.CurrentDate = new DateTime(2021, 10, 17, 4, 0, 0);
            data = sm.NextOcurrence();
            Assert.Equal(data[0].OcurrenceDate, new DateTime(2021, 10, 25, 6, 0, 0));
            Assert.Equal(data[0].Description, "Ocurre el ultimo lunes de cada 2 mes(es). Cada 2 hora(s) entre 04:00 y 08:00. La siguiente cita se producirá el 25/10/2021 a las 6:00 comenzando el 01/01/2021");

            sm.CurrentDate = new DateTime(2021, 10, 17, 6, 0, 0);
            data = sm.NextOcurrence();
            Assert.Equal(data[0].OcurrenceDate, new DateTime(2021, 10, 25, 8, 0, 0));
            Assert.Equal(data[0].Description, "Ocurre el ultimo lunes de cada 2 mes(es). Cada 2 hora(s) entre 04:00 y 08:00. La siguiente cita se producirá el 25/10/2021 a las 8:00 comenzando el 01/01/2021");

            sm.CurrentDate = new DateTime(2021, 10, 17, 8, 0, 0);
            data = sm.NextOcurrence();
            Assert.Equal(data[0].OcurrenceDate, new DateTime(2021, 12, 27, 4, 0, 0));
            Assert.Equal(data[0].Description, "Ocurre el ultimo lunes de cada 2 mes(es). Cada 2 hora(s) entre 04:00 y 08:00. La siguiente cita se producirá el 27/12/2021 a las 4:00 comenzando el 01/01/2021");
            ...
            Assert.Equal(data[0].Description, "Ocurre el primer sabado de cada 2 mes(es). Cada 2 hora(s) entre 04:00 y 08:00. La siguiente cita se producirá el 04/12/2021 a las 4:00 comenzando el 01/01/2021");

            sm.CurrentDate = new DateTime(2021, 12, 4, 4, 0, 0);
            data = sm.NextOcurrence();
            Assert.Equal(data[0].OcurrenceDate, new DateTime(2021, 12, 4, 6, 0, 0));
            Assert.Equal(data[0].Description, "Ocurre el primer sabado de cada 2 mes(es). Cada 2 hora(s) entre 04:00 y 08:00. La siguiente cita se producirá el 04/12/2021 a las 6:00 comenzando el 01/01/2021");

            sm.CurrentDate = new DateTime(2021, 12, 4, 6, 0, 0);
            data = sm.NextOcurrence();
            Assert.Equal(data[0].OcurrenceDate, new DateTime(2021, 12, 4, 8, 0, 0));
            Assert.Equal(data[0].Description, "Ocurre el primer sabado de cada 2 mes(es). Cada 2 hora(s) entre 04:00 y 08:00. La siguiente cita se producirá el 04/12/2021 a las 8:00 comenzando el 01/01/2021");

            sm.CurrentDate = new DateTime(2021, 12, 4, 8, 0, 0);
            data = sm.NextOcurrence();
            Assert.Equal(data[0].OcurrenceDate, new DateTime(2022, 2, 5, 4, 0, 0));
            Assert.Equal(data[0].Description, "Ocurre el primer sabado de cada 2 mes(es). Cada 2 hora(s) entre 04:00 y 08:00. La siguiente cita se producirá el 05/02/2022 a las 4:00 comenzando el 01/01/2021");
            ...
            Assert.Equal(data[0].Description, "Ocurre el segundo sabado de cada 2 mes(es). Cada 2 hora(s) entre 04:00 y 08:00. La siguiente cita se producirá el 11/12/2021 a las 4:00 comenzando el 01/01/2021");

            sm.CurrentDate = new DateTime(2021, 12, 11, 4, 0, 0);
            data = sm.NextOcurrence();
            Assert.Equal(data[0].OcurrenceDate, new DateTime(2021, 12, 11, 6, 0, 0));
            Assert.Equal(data[0].Description, "Ocurre el segundo sabado de cada 2 mes(es). Cada 2 hora(s) entre 04:00 y 08:00. La siguiente cita se producirá el 11/12/2021 a las 6:00 comenzando el 01/01/2021");

            sm.CurrentDate = new DateTime(2021, 12, 11, 6, 0, 0);
            data = sm.NextOcurrence();
            Assert.Equal(data[0].OcurrenceDate, new DateTime(2021, 12, 11, 8, 0, 0));
            Assert.Equal(data[0].Description, "Ocurre el segundo sabado de cada 2 mes(es). Cada 2 hora(s) entre 04:00 y 08:00. La siguiente cita se producirá el 11/12/2021 a las 8:00 comenzando el 01/01/2021");

            sm.CurrentDate = new DateTime(2021, 12, 11, 8, 0, 0);
            data = sm.NextOcurrence();
            Assert.Equal(data[0].OcurrenceDate, new DateTime(2022, 2, 12, 4, 0, 0));
            Assert.Equal(data[0].Description, "Ocurre el segundo sabado de cada 2 mes(es). Cada 2 hora(s) entre 04:00 y 08:00. La siguiente cita se producirá el 12/02/2022 a las 4:00 comenzando el 01/01/2021");
            ...
            Assert.Equal(data[0].Description, "Ocurre el tercer sabado de cada 2 mes(es). Cada 2 hora(s) entre 04:00 y 08:00. La siguiente cita se producirá el 18/12/2021 a las 4:00 comenzando el 01/01/2021");

            sm.CurrentDate = new DateTime(2021, 12, 18, 4, 0, 0);
            data = sm.NextOcurrence();
            Assert.Equal(data[0].OcurrenceDate, new DateTime(2021, 12, 18, 6, 0, 0));
            Assert.Equal(data[0].Description, "Ocurre el tercer sabado de cada 2 mes(es). Cada 2 hora(s) entre 04:00 y 08:00. La siguiente cita se producirá el 18/12/2021 a las 6:00 comenzando el 01/01/2021");

            sm.CurrentDate = new DateTime(2021, 12, 18, 6, 0, 0);
            data = sm.NextOcurrence();
            Assert.Equal(data[0].OcurrenceDate, new DateTime(2021, 12, 18, 8, 0, 0));
            Assert.Equal(data[0].Description, "Ocurre el tercer sabado de cada 2 mes(es). Cada 2 hora(s) entre 04:00 y 08:00. La siguiente cita se producirá el 18/12/2021 a las 8:00 comenzando el 01/01/2021");

            sm.CurrentDate = new DateTime(2021, 12, 18, 8, 0, 0);
            data = sm.NextOcurrence();
            Assert.Equal(data[0].OcurrenceDate, new DateTime(2022, 2, 19, 4, 0, 0));
            Assert.Equal(data[0].Description, "Ocurre el tercer sabado de cada 2 mes(es). Cada 2 hora(s) entre 04:00 y 08:00. La siguiente cita se producirá el 19/02/2022 a las 4:00 comenzando el 01/01/2021");
            ...
            Assert.Equal(data[0].Description, "Ocurre el cuarto sabado de cada 2 mes(es). Cada 2 hora(s) entre 04:00 y 08:00. La siguiente cita se producirá el 23/10/2021 a las 4:00 comenzando el 01/01/2021");

            sm.CurrentDate = new DateTime(2021, 10, 23, 4, 0, 0);
            data = sm.NextOcurrence();
            Assert.Equal(data[0].OcurrenceDate, new DateTime(2021, 10, 23, 6, 0, 0));
            Assert.Equal(data[0].Description, "Ocurre el cuarto sabado de cada 2 mes(es). Cada 2 hora(s) entre 04:00 y 08:00. La siguiente cita se producirá el 23/10/2021 a las 6:00 comenzando el 01/01/2021");

            sm.CurrentDate = new DateTime(2021, 10, 23, 6, 0, 0);
            data = sm.NextOcurrence();
            Assert.Equal(data[0].OcurrenceDate, new DateTime(2021, 10, 23, 8, 0, 0));
            Assert.Equal(data[0].Description, "Ocurre el cuarto sabado de cada 2 mes(es). Cada 2 hora(s) entre 04:00 y 08:00. La siguiente cita se producirá el 23/10/2021 a las 8:00 comenzando el 01/01/2021");

            sm.CurrentDate = new DateTime(2021, 10, 23, 8, 0, 0);
            data = sm.NextOcurrence();
            Assert.Equal(data[0].OcurrenceDate, new DateTime(2021, 12, 25, 4, 0, 0));
            Assert.Equal(data[0].Description, "Ocurre el cuarto sabado de cada 2 mes(es). Cada 2 hora(s) entre 04:00 y 08:00. La siguiente cita se producirá el 25/12/2021 a las 4:00 comenzando el 01/01/2021");
            ...
            Assert.Equal(data[0].Description, "Ocurre el ultimo sabado de cada 2 mes(es). Cada 2 hora(s) entre 04:00 y 08:00. La siguiente cita se producirá el 30/10/2021 a las 4:00 comenzando el 01/01/2021");

            sm.CurrentDate = new DateTime(2021, 10, 30, 4, 0, 0);
            data = sm.NextOcurrence();
            Assert.Equal(data[0].OcurrenceDate, new DateTime(2021, 10, 30, 6, 0, 0));
            Assert.Equal(data[0].Description, "Ocurre el ultimo sabado de cada 2 mes(es). Cada 2 hora(s) entre 04:00 y 08:00. La siguiente cita se producirá el 30/10/2021 a las 6:00 comenzando el 01/01/2021");

            sm.CurrentDate = new DateTime(2021, 10, 30, 6, 0, 0);
            data = sm.NextOcurrence();
            Assert.Equal(data[0].OcurrenceDate, new DateTime(2021, 10, 30, 8, 0, 0));
            Assert.Equal(data[0].Description, "Ocurre el ultimo sabado de cada 2 mes(es). Cada 2 hora(s) entre 04:00 y 08:00. La siguiente cita se producirá el 30/10/2021 a las 8:00 comenzando el 01/01/2021");

            sm.CurrentDate = new DateTime(2021, 10, 30, 8, 0, 0);
            data = sm.NextOcurrence();
            Assert.Equal(data[0].OcurrenceDate, new DateTime(2021, 12, 25, 4, 0, 0));
            Assert.Equal(data[0].Description, "Ocurre el ultimo sabado de cada 2 mes(es). Cada 2 hora(s) entre 04:00 y 08:00. La siguiente cita se producirá el 25/12/2021 a las 4:00 comenzando el 01/01/2021");
            ...
            data = sm.NextOcurrence();
            Assert.Equal(data[0].OcurrenceDate, new DateTime(2021, 12, 4, 4, 0, 0));
            Assert.Equal(data[0].Description, "Ocurre el primer dia del fin de semana de cada 2 mes(es). Cada 2 hora(s) entre 04:00 y 08:00. La siguiente cita se producirá el 04/12/2021 a las 4:00 comenzando el 01/01/2021");

            sm.CurrentDate = new DateTime(2021, 12, 4, 4, 0, 0);
            data = sm.NextOcurrence();
            Assert.Equal(data[0].OcurrenceDate, new DateTime(2021, 12, 4, 6, 0, 0));
            Assert.Equal(data[0].Description, "Ocurre el primer dia del fin de semana de cada 2 mes(es). Cada 2 hora(s) entre 04:00 y 08:00. La siguiente cita se producirá el 04/12/2021 a las 6:00 comenzando el 01/01/2021");

            sm.CurrentDate = new DateTime(2021, 12, 4, 6, 0, 0);
            data = sm.NextOcurrence();
            Assert.Equal(data[0].OcurrenceDate, new DateTime(2021, 12, 4, 8, 0, 0));
            Assert.Equal(data[0].Description, "Ocurre el primer dia del fin de semana de cada 2 mes(es). Cada 2 hora(s) entre 04:00 y 08:00. La siguiente cita se producirá el 04/12/2021 a las 8:00 comenzando el 01/01/2021");

            sm.CurrentDate = new DateTime(2021, 12, 4, 8, 0, 0);
            data = sm.NextOcurrence();
            Assert.Equal(data[0].OcurrenceDate, new DateTime(2022, 2, 5, 4, 0, 0));
            Assert.Equal(data[0].Description, "Ocurre el primer dia del fin de semana de cada 2 mes(es). Cada 2 hora(s) entre 04:00 y 08:00. La siguiente cita se producirá el 05/02/2022 a las 4:00 comenzando el 01/01/2021");
            ...
            Assert.Equal(data[0].Description, "Ocurre el segundo dia del fin de semana de cada 2 mes(es). Cada 2 hora(s) entre 04:00 y 08:00. La siguiente cita se producirá el 05/12/2021 a las 4:00 comenzando el 01/01/2021");

            sm.CurrentDate = new DateTime(2021, 12, 5, 4, 0, 0);
            data = sm.NextOcurrence();
            Assert.Equal(data[0].OcurrenceDate, new DateTime(2021, 12, 5, 6, 0, 0));
            Assert.Equal(data[0].Description, "Ocurre el segundo dia del fin de semana de cada 2 mes(es). Cada 2 hora(s) entre 04:00 y 08:00. La siguiente cita se producirá el 05/12/2021 a las 6:00 comenzando el 01/01/2021");

            sm.CurrentDate = new DateTime(2021, 12, 5, 6, 0, 0);
            data = sm.NextOcurrence();
            Assert.Equal(data[0].OcurrenceDate, new DateTime(2021, 12, 5, 8, 0, 0));
            Assert.Equal(data[0].Description, "Ocurre el segundo dia del fin de semana de cada 2 mes(es). Cada 2 hora(s) entre 04:00 y 08:00. La siguiente cita se producirá el 05/12/2021 a las 8:00 comenzando el 01/01/2021");

            sm.CurrentDate = new DateTime(2021, 12, 5, 8, 0, 0);
            data = sm.NextOcurrence();
            Assert.Equal(data[0].OcurrenceDate, new DateTime(2022, 2, 6, 4, 0, 0));
            Assert.Equal(data[0].Description, "Ocurre el segundo dia del fin de semana de cada 2 mes(es). Cada 2 hora(s) entre 04:00 y 08:00. La siguiente cita se producirá el 06/02/2022 a las 4:00 comenzando el 01/01/2021");
            ...
            data = sm.NextOcurrence();
            Assert.Equal(data[0].OcurrenceDate, new DateTime(2021, 12, 11, 4, 0, 0));
            Assert.Equal(data[0].Description, "Ocurre el tercer dia del fin de semana de cada 2 mes(es). Cada 2 hora(s) entre 04:00 y 08:00. La siguiente cita se producirá el 11/12/2021 a las 4:00 comenzando el 01/01/2021");

            sm.CurrentDate = new DateTime(2021, 12, 11, 4, 0, 0);
            data = sm.NextOcurrence();
            Assert.Equal(data[0].OcurrenceDate, new DateTime(2021, 12, 11, 6, 0, 0));
            Assert.Equal(data[0].Description, "Ocurre el tercer dia del fin de semana de cada 2 mes(es). Cada 2 hora(s) entre 04:00 y 08:00. La siguiente cita se producirá el 11/12/2021 a las 6:00 comenzando el 01/01/2021");

            sm.CurrentDate = new DateTime(2021, 12, 11, 6, 0, 0);
            data = sm.NextOcurrence();
            Assert.Equal(data[0].OcurrenceDate, new DateTime(2021, 12, 11, 8, 0, 0));
            Assert.Equal(data[0].Description, "Ocurre el tercer dia del fin de semana de cada 2 mes(es). Cada 2 hora(s) entre 04:00 y 08:00. La siguiente cita se producirá el 11/12/2021 a las 8:00 comenzando el 01/01/2021");

            sm.CurrentDate = new DateTime(2021, 12, 11, 8, 0, 0);
            data = sm.NextOcurrence();
            Assert.Equal(data[0].OcurrenceDate, new DateTime(2022, 2, 12, 4, 0, 0));
            Assert.Equal(data[0].Description, "Ocurre el tercer dia del fin de semana de cada 2 mes(es). Cada 2 hora(s) entre 04:00 y 08:00. La siguiente cita se producirá el 12/02/2022 a las 4:00 comenzando el 01/01/2021");
            ...
            Assert.Equal(data[0].Description, "Ocurre el cuarto dia del fin de semana de cada 2 mes(es). Cada 2 hora(s) entre 04:00 y 08:00. La siguiente cita se producirá el 12/12/2021 a las 4:00 comenzando el 01/01/2021");

            sm.CurrentDate = new DateTime(2021, 12, 12, 4, 0, 0);
            data = sm.NextOcurrence();
            Assert.Equal(data[0].OcurrenceDate, new DateTime(2021, 12, 12, 6, 0, 0));
            Assert.Equal(data[0].Description, "Ocurre el cuarto dia del fin de semana de cada 2 mes(es). Cada 2 hora(s) entre 04:00 y 08:00. La siguiente cita se producirá el 12/12/2021 a las 6:00 comenzando el 01/01/2021");

            sm.CurrentDate = new DateTime(2021, 12, 12, 6, 0, 0);
            data = sm.NextOcurrence();
            Assert.Equal(data[0].OcurrenceDate, new DateTime(2021, 12, 12, 8, 0, 0));
            Assert.Equal(data[0].Description, "Ocurre el cuarto dia del fin de semana de cada 2 mes(es). Cada 2 hora(s) entre 04:00 y 08:00. La siguiente cita se producirá el 12/12/2021 a las 8:00 comenzando el 01/01/2021");

            sm.CurrentDate = new DateTime(2021, 12, 12, 8, 0, 0);
            data = sm.NextOcurrence();
            Assert.Equal(data[0].OcurrenceDate, new DateTime(2022, 2, 13, 4, 0, 0));
            Assert.Equal(data[0].Description, "Ocurre el cuarto dia del fin de semana de cada 2 mes(es). Cada 2 hora(s) entre 04:00 y 08:00. La siguiente cita se producirá el 13/02/2022 a las 4:00 comenzando el 01/01/2021");
            ...
            Assert.Equal(data[0].Description, "Ocurre el ultimo dia del fin de semana de cada 2 mes(es). Cada 2 hora(s) entre 04:00 y 08:00. La siguiente cita se producirá el 31/10/2021 a las 4:00 comenzando el 01/01/2021");

            sm.CurrentDate = new DateTime(2021, 10, 31, 4, 0, 0);
            data = sm.NextOcurrence();
            Assert.Equal(data[0].OcurrenceDate, new DateTime(2021, 10, 31, 6, 0, 0));
            Assert.Equal(data[0].Description, "Ocurre el ultimo dia del fin de semana de cada 2 mes(es). Cada 2 hora(s) entre 04:00 y 08:00. La siguiente cita se producirá el 31/10/2021 a las 6:00 comenzando el 01/01/2021");

            sm.CurrentDate = new DateTime(2021, 10, 31, 6, 0, 0);
            data = sm.NextOcurrence();
            Assert.Equal(data[0].OcurrenceDate, new DateTime(2021, 10, 31, 8, 0, 0));
            Assert.Equal(data[0].Description, "Ocurre el ultimo dia del fin de semana de cada 2 mes(es). Cada 2 hora(s) entre 04:00 y 08:00. La siguiente cita se producirá el 31/10/2021 a las 8:00 comenzando el 01/01/2021");

            sm.CurrentDate = new DateTime(2021, 10, 31, 8, 0, 0);
            data = sm.NextOcurrence();
            Assert.Equal(data[0].OcurrenceDate, new DateTime(2021, 12, 26, 4, 0, 0));
            Assert.Equal(data[0].Description, "Ocurre el ultimo dia del fin de semana de cada 2 mes(es). Cada 2 hora(s) entre 04:00 y 08:00. La siguiente cita se producirá el 26/12/2021 a las 4:00 comenzando el 01/01/2021");
            ...
            Assert.Equal(data[0].Description, "Ocurre el primer dia de cada 2 mes(es). Cada 2 hora(s) entre 04:00 y 08:00. La siguiente cita se producirá el 01/12/2021 a las 4:00 comenzando el 01/01/2021");

            sm.CurrentDate = new DateTime(2021, 12, 1, 4, 0, 0);
            data = sm.NextOcurrence();
            Assert.Equal(data[0].OcurrenceDate, new DateTime(2021, 12, 1, 6, 0, 0));
            Assert.Equal(data[0].Description, "Ocurre el primer dia de cada 2 mes(es). Cada 2 hora(s) entre 04:00 y 08:00. La siguiente cita se producirá el 01/12/2021 a las 6:00 comenzando el 01/01/2021");

            sm.CurrentDate = new DateTime(2021, 12, 1, 6, 0, 0);
            data = sm.NextOcurrence();
            Assert.Equal(data[0].OcurrenceDate, new DateTime(2021, 12, 1, 8, 0, 0));
            Assert.Equal(data[0].Description, "Ocurre el primer dia de cada 2 mes(es). Cada 2 hora(s) entre 04:00 y 08:00. La siguiente cita se producirá el 01/12/2021 a las 8:00 comenzando el 01/01/2021");

            sm.CurrentDate = new DateTime(2021, 12, 1, 8, 0, 0);
            data = sm.NextOcurrence();
            Assert.Equal(data[0].OcurrenceDate, new DateTime(2022, 2, 1, 4, 0, 0));
            Assert.Equal(data[0].Description, "Ocurre el primer dia de cada 2 mes(es). Cada 2 hora(s) entre 04:00 y 08:00. La siguiente cita se producirá el 01/02/2022 a las 4:00 comenzando el 01/01/2021");
            ...
            data = sm.NextOcurrence();
            Assert.Equal(data[0].OcurrenceDate, new DateTime(2021, 10, 31, 4, 0, 0));
            Assert.Equal(data[0].Description, "Ocurre el ultimo dia de cada 2 mes(es). Cada 2 hora(s) entre 04:00 y 08:00. La siguiente cita se producirá el 31/10/2021 a las 4:00 comenzando el 01/01/2021");

            sm.CurrentDate = new DateTime(2021, 10, 31, 4, 0, 0);
            data = sm.NextOcurrence();
            Assert.Equal(data[0].OcurrenceDate, new DateTime(2021, 10, 31, 6, 0, 0));
            Assert.Equal(data[0].Description, "Ocurre el ultimo dia de cada 2 mes(es). Cada 2 hora(s) entre 04:00 y 08:00. La siguiente cita se producirá el 31/10/2021 a las 6:00 comenzando el 01/01/2021");

            sm.CurrentDate = new DateTime(2021, 10, 31, 6, 0, 0);
            data = sm.NextOcurrence();
            Assert.Equal(data[0].OcurrenceDate, new DateTime(2021, 10, 31, 8, 0, 0));
            Assert.Equal(data[0].Description, "Ocurre el ultimo dia de cada 2 mes(es). Cada 2 hora(s) entre 04:00 y 08:00. La siguiente cita se producirá el 31/10/2021 a las 8:00 comenzando el 01/01/2021");

            sm.CurrentDate = new DateTime(2021, 10, 31, 8, 0, 0);
            data = sm.NextOcurrence();
            Assert.Equal(data[0].OcurrenceDate, new DateTime(2021, 12, 31, 4, 0, 0));
            Assert.Equal(data[0].Description, "Ocurre el ultimo dia de cada 2 mes(es). Cada 2 hora(s) entre 04:00 y 08:00. La siguiente cita se producirá el 31/12/2021 a las 4:00 comenzando el 01/01/2021");
            ...
            data = sm.NextOcurrence();
            Assert.Equal(data[0].OcurrenceDate, new DateTime(2021, 12, 1, 4, 0, 0));
            Assert.Equal(data[0].Description, "Ocurre el primer dia laboral de cada 2 mes(es). Cada 2 hora(s) entre 04:00 y 08:00. La siguiente cita se producirá el 01/12/2021 a las 4:00 comenzando el 01/01/2021");

            sm.CurrentDate = new DateTime(2021, 12, 1, 4, 0, 0);
            data = sm.NextOcurrence();
            Assert.Equal(data[0].OcurrenceDate, new DateTime(2021, 12, 1, 6, 0, 0));
            Assert.Equal(data[0].Description, "Ocurre el primer dia laboral de cada 2 mes(es). Cada 2 hora(s) entre 04:00 y 08:00. La siguiente cita se producirá el 01/12/2021 a las 6:00 comenzando el 01/01/2021");

            sm.CurrentDate = new DateTime(2021, 12, 1, 6, 0, 0);
            data = sm.NextOcurrence();
            Assert.Equal(data[0].OcurrenceDate, new DateTime(2021, 12, 1, 8, 0, 0));
            Assert.Equal(data[0].Description, "Ocurre el primer dia laboral de cada 2 mes(es). Cada 2 hora(s) entre 04:00 y 08:00. La siguiente cita se producirá el 01/12/2021 a las 8:00 comenzando el 01/01/2021");

            sm.CurrentDate = new DateTime(2021, 12, 1, 8, 0, 0);
            data = sm.NextOcurrence();
            Assert.Equal(data[0].OcurrenceDate, new DateTime(2022, 2, 1, 4, 0, 0));
            Assert.Equal(data[0].Description, "Ocurre el primer dia laboral de cada 2 mes(es). Cada 2 hora(s) entre 04:00 y 08:00. La siguiente cita se producirá el 01/02/2022 a las 4:00 comenzando el 01/01/2021");
            ...
            Assert.Equal(data[0].Description, "Ocurre el ultimo dia laboral de cada 2 mes(es). Cada 2 hora(s) entre 04:00 y 08:00. La siguiente cita se producirá el 29/10/2021 a las 4:00 comenzando el 01/01/2021");

            sm.CurrentDate = new DateTime(2021, 10, 29, 4, 0, 0);
            data = sm.NextOcurrence();
            Assert.Equal(data[0].OcurrenceDate, new DateTime(2021, 10, 29, 6, 0, 0));
            Assert.Equal(data[0].Description, "Ocurre el ultimo dia laboral de cada 2 mes(es). Cada 2 hora(s) entre 04:00 y 08:00. La siguiente cita se producirá el 29/10/2021 a las 6:00 comenzando el 01/01/2021");

            sm.CurrentDate = new DateTime(2021, 10, 29, 6, 0, 0);
            data = sm.NextOcurrence();
            Assert.Equal(data[0].OcurrenceDate, new DateTime(2021, 10, 29, 8, 0, 0));
            Assert.Equal(data[0].Description, "Ocurre el ultimo dia laboral de cada 2 mes(es). Cada 2 hora(s) entre 04:00 y 08:00. La siguiente cita se producirá el 29/10/2021 a las 8:00 comenzando el 01/01/2021");

            sm.CurrentDate = new DateTime(2021, 10, 29, 8, 0, 0);
            data = sm.NextOcurrence();
            Assert.Equal(data[0].OcurrenceDate, new DateTime(2021, 12, 31, 4, 0, 0));
            Assert.Equal(data[0].Description, "Ocurre el ultimo dia laboral de cada 2 mes(es). Cada 2 hora(s) entre 04:00 y 08:00. La siguiente cita se producirá el 31/12/2021 a las 4:00 comenzando el 01/01/2021");
