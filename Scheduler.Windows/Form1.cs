        ...
        private void CalculateBT_Click(object sender, EventArgs e)
        {
            ...
            if (TypeLB.SelectedIndex == 0)     // Only one ocurrence
            {
                try
                {
                    ...
                    {
                        case 0:
                            Gestor.Language = SupportedLanguagesEnum.es_ES;
                            break;
                        case 1:
                            Gestor.Language = SupportedLanguagesEnum.en_GB;
                            break;
                        case 2:
                            Gestor.Language = SupportedLanguagesEnum.en_US;
                            break;
                    }
                    ...
                    case 2:  // Monthly Ocurrence
                        try
                        {
                            ...
                            if (this.MonthlyDayCB.Checked == true)
                            {
                                ...
                                Gestor.MonthlyFixedDay  = (int)this.MonthlyDayEveryTB.Value;
